-- ===========================================
-- PAINEL DE METRICAS - RESTAURANTE
-- Schema PostgreSQL
-- ===========================================
...
INSERT INTO cardapio (nome, categoria_id, preco, custo) VALUES
    ...
    ('File a Parmegiana',    2, 68.00, 22.00),
    ('Macarrao Carbonara',   2, 48.00, 14.00),
    ('Risoto de Camarao',    2, 75.00, 28.00),
    ('Petit Gateau',         3, 32.00, 8.00),
    ('Pudim',                3, 22.00, 5.00),
    ('Refrigerante',         4, 10.00, 3.00),
    ('Suco Natural',         4, 14.00, 4.00),
    ('Agua Mineral',         4, 6.00,  1.50),
    ('Cerveja',              4, 12.00, 4.00),
    ('Porcao de Batata',     5, 38.00, 10.00),
    ('Porcao de Calabresa',  5, 42.00, 12.00);
